...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "RegApartmentMeteringSender.findAll", query = "SELECT r FROM RegApartmentMeteringSender r")})
public class RegApartmentMeteringSender implements Serializable {
